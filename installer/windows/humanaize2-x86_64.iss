...
; Generated for Windows x86_64 architecture

[Setup]
AppId={{HUMANAIZE2-X64-2024}}
AppName=Humanaize 2.0 Agent
AppVersion=2.2.3
AppVerName=Humanaize 2.0 Agent (x64)
...
OutputDir=output
OutputBaseFilename=Humanaize2-Setup-x86_64
Compression=lzma
...
[Run]
Filename: "{app}\Humanaize2-x86_64.exe"; Description: "{cm:LaunchProgram,Humanaize 2.0 Agent}"; Flags: nowait postinstall skipifsilent